...
export default async function DashboardPage() {
  ...
  const checklistSteps = [
    ...
    {
      label: "Turn on Auto Mode",
      description: "Activate automated outreach so reminders fire without manual review.",
      done: !!(p?.auto_mode),
      href: "/dashboard/settings#auto-mode",
      cta: "Enable",
    },
    {
      label: "Set up PM alerts",
      description: "Get texted when a tenant hits Pay or Quit, misses an installment, or replies to SMS.",
      done: !!(p?.pm_phone && p?.pm_alerts_enabled),
      href: "/dashboard/settings#pm-alerts",
      cta: "Set up",
    },
  ]
