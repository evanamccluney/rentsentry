...
const INTERVENTION_LABELS: Record<string, string> = {
  ...
  intake_review_required:      "Existing balance review required",
  current_balance_reminder:    "Past-due balance reminder sent",
...
const USER_ACTION_ICONS: Record<string, { icon: typeof Phone; color: string; bg: string }> = {
  ...
  intake_review_required:     { icon: ClipboardList, color: "text-amber-300",   bg: "bg-amber-500/10 border-amber-500/20" },
  current_balance_reminder:   { icon: MessageSquare, color: "text-yellow-400",  bg: "bg-yellow-500/10 border-yellow-500/20" },
