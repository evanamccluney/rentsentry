...
export const STATE_RULES: Record<string, StateRule> = {
  ...
  MD: { days: 10, title: "10-Day Notice of Intent to File",           serviceNote: "Use Maryland Courts form DC-CV-115 before filing; verify service requirements.", legalText: "Md. Code Ann., Real Prop. § 8-401" },
  ...
  NJ: { days: 30, title: "Notice to Pay Rent or Quit",                serviceNote: "New Jersey requirements vary by tenancy and notice type. Verify before service.", legalText: "N.J. Stat. Ann. § 2A:18-61.2" },
